...
# Primero, preguntamos al usuario la edad de dos personas.

age1 = int(input('Introduce la edad de la primera persona: '))
age2 = int(input('Introduce la edad de la segunda persona: '))

# Creamos la estructura alternativa con if y elif y comprobamos quién es mayor o si tienen la misma edad.
