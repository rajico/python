...
class Writer:
    ...
    def __init__(self, width=None, height=None,
        ...
        *height*).
        ...
        colour mapped images; colour mapped images cannot have a bit depth
        16.
    ...
    def write_passes(self, outfile, rows, packed=False):
        ...
        for i, row in enumrows:
            ...
            # we used "up", "average", or "path" on such a line.
            data.append(0)
            extend(row)
    ...
    def write_packed(self, outfile, rows):
        ...
        This method should not be used when the source image a bit depth
...
def filter_scanline(type, line, fo, prev=None):
    ...
    if not prev:
        # We're on the first line.  Some filters can be reduced
...
class Reader:
    ...
    def asRGB8(self):
        ...
        all the information; where the source image has a bit depth
